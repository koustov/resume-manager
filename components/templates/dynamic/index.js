...
const ComponentTemplate = ({ data }) => {
	return (
		<div className='resume-wrapper'>
			<div style={{ background: '#ffffff', display: 'flex', width: '100%' }}>
				<div
					className={styles['left-box']}
					style={{ backgroundColor: data.sidebar_color }}>
					<div className={styles['top-left']}>
						<img className={[styles.img]} src={data.image} alt='Cody Man' />
						...
						<div className={styles['objective']}>
							...
							<div className={styles['objective-text']}>
								<ContainerEdtitable text={data.about} datafield='about' />
							</div>
						</div>
				...
				<div style={{ display: 'flex', flexDirection: 'column' }}>
					<div className={styles['work-experience']}>
						...
						<h1 className={styles['work-title']}>Work Experience</h1>
						{[1, 2, 3].map((we, wei) => {
							<div className={styles['job-box']} key={wei}>
								<div className={styles['job-title']}>
									<ContainerEdtitable
										text={data[`jobtitle${we}`]}
										datafield={`jobtitle${we}`}
									/>{' '}
									<ContainerEdtitable
										text={data[`organization${we}`]}
										datafield={`organization${we}`}
									/>
								</div>
								<div className={styles['job-date']}>
									<ContainerEdtitable text={data[`from${we}`]} datafield={`from${we}`} />
									- <ContainerEdtitable text={data[`to${we}`]} datafield={`to${we}`} />
								</div>
								<ContainerEdtitable
									datafield={'workdetails'}
									className={styles['job-description']}
									text={`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vitae
                laoreet diam.`}
								/>
							</div>;
						})}
					...
					<div className={styles['education']}>
						...
						<div className={styles['job-box']}>
							<div className={styles['job-title']}>Job 1 @Employername</div>
							<div className={styles['job-date']}>Jan 2015 - Present</div>
						...
						<div className={styles['job-box']}>
							<div className={styles['job-title']}>Job 2 @Employername</div>
							<div className={styles['job-date']}>Jan 2015 - Present</div>
							<div className={styles['job-description']}>
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vitae
								laoreet diam.
						...
						<div className={styles['job-box']}>
							<div className={styles['job-title']}>Job 3 @Employername</div>
							<div className={styles['job-date']}>Jan 2015 - Present</div>
							<div className={styles['job-description']}>
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vitae
								laoreet diam.
						...
						<div className={styles['skills']}>
							...
							<div className={styles['graph']}>
								<ul className={styles.ul}>
									<li className={`${styles.li} ${styles['l1']}`}>HTML</li>
									<li className={`${styles.li} ${styles['l2']}`}>CSS</li>
									<li className={`${styles.li} ${styles['l3']}`}>
										Knowledge Management
									</li>
									<li className={`${styles.li} ${styles['l4']}`}>ServiceNow</li>
								</ul>
							</div>
						</div>
...
const ResumeTemplate = {
	name: 'Dynamic',
	description: 'A dynamic resume for aggressive profile',
